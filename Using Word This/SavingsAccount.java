public class SavingsAccount{
    ...
    public void addMoney(int balanceDollar){
      ...
      System.out.println("Adding " + this.balanceDollar + " dollars to the account.");//output: Adding 1000 dollars to the account.
      this.balanceDollar += balanceDollar;
      System.out.println("The new balance is " + this.balanceDollar + " dollars.");//output: The new balance is 2000 dollars.
    }
